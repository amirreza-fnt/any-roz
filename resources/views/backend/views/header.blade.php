        ...
        <div class="header-right">
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-big dropdown-menu-right">
                        <div class="p-4 text-center" data-background-image="{{ asset('assets/back-end/assets/media/image/image1.png') }}">
                            ...
                            <ul class="list-group list-group-flush">
                                    ...
                                    <a href="#" class="list-group-item d-flex hide-show-toggler">
                                        <div>
                                            <figure class="avatar avatar-sm m-r-15">
                                                <img src="{{ asset('assets/back-end/assets/media/image/user/man_avatar1.jpg') }}" class="rounded-circle" alt="user">
                                            </figure>
                                        </div>
                                ...
                                <li>
                                    <a href="#" class="list-group-item d-flex align-items-center hide-show-toggler">
                                        <div>
                                            <figure class="avatar avatar-sm m-r-15">
                                                <img src="{{ asset('assets/back-end/assets/media/image/user/women_avatar5.jpg') }}" class="rounded-circle" alt="user">
                                            </figure>
                                        </div>
                                        <div class="flex-grow-1">
                                            <p class="mb-0 d-flex justify-content-between line-height-25">
                                ...
                                <li>
                                    <a href="#" class="list-group-item d-flex align-items-center hide-show-toggler">
                                        <div>
                                            <figure class="avatar avatar-sm m-r-15">
                                                <img src="{{ asset('assets/back-end/assets/media/image/user/man_avatar3.jpg') }}" class="rounded-circle" alt="user">
                                            </figure>
                                        </div>
                                        <div class="flex-grow-1">
                                            <p class="mb-0 d-flex justify-content-between line-height-25">
                                ...
                                <li>
                                    <a href="#" class="list-group-item d-flex hide-show-toggler">
                                        <div>
                                            <figure class="avatar avatar-sm m-r-15">
                                                <img src="{{ asset('assets/back-end/assets/media/image/user/man_avatar2.jpg') }}" class="rounded-circle" alt="user">
                                            </figure>
                                        </div>
                                        <div class="flex-grow-1">
                                            <p class="mb-0 d-flex justify-content-between line-height-25">
                                ...
                                <li>
                                    <a href="#" class="list-group-item d-flex align-items-center hide-show-toggler">
                                        <div>
                                            <figure class="avatar avatar-sm m-r-15">
                                                <img src="{{ asset('assets/back-end/assets/media/image/user/women_avatar1.jpg') }}" class="rounded-circle" alt="user">
                                            </figure>
                                        </div>
                                        <div class="flex-grow-1">
                                            <p class="mb-0 d-flex justify-content-between line-height-25">
