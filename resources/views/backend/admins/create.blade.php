            ...
            <div class="col-lg-4 mb-3">
                <div class="card border-0 shadow-sm h-100">
                    ...
                    <div class="card-body">
                        ...
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" name="is_colleague" id="is_colleague" value="1" {{ old('is_colleague', '0') === '1' || old('is_colleague') === true ? 'checked' : '' }}>
                        ...
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" name="is_colleague_support" id="is_colleague_support" value="1" {{ old('is_colleague_support', '0') === '1' || old('is_colleague_support') === true ? 'checked' : '' }}>
