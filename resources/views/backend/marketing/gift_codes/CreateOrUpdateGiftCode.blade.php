...
@push('scripts')
    ...
    <script>
        (function () {
            ...
            $('#btn-today-start').on('click', function() { selectToday('.gc-shamsi-date[name="starts_at_shamsi"]'); });
            $('#btn-today-end').on('click', function() { selectToday('.gc-shamsi-date[name="expires_at_shamsi"]'); });
