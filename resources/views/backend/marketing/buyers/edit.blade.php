...
<div class="main-content">
    <div class="container">
        ...
        <form method="post" action="{{ route('admin.marketing.buyers.update', $buyer) }}" class="card border-0 shadow-sm">
            @csrf
            @method('PUT')
            <div class="card-body">
                @include('backend.marketing.buyers._form', ['buyer' => $buyer, 'provinces' => $provinces, 'cities' => $cities])
            </div>
