...
<div class="main-content">
    <div class="container-fluid">
        ...
        <div class="acct-site-hero">
            ...
            <p class="mb-0">فقط فاکتورهایی که از مسیر <strong>تأیید فروش بازاریاب</strong> ساخته نشده‌اند (معمولاً <code>marketing_sale_id</code> خالی)؛ برای رکوردهای قدیمی، منبع <code>site</code> یا خالی هم در همین کانال دیده می‌شود. فروش بازاریابی تأییدشده اینجا نیست. <strong>تاریخ گزارش:</strong> اگر «تاریخ پرداخت» غیرواقعی باشد، از تاریخ ثبت فاکتور استفاده می‌شود تا سفارش از بازه حذف نشود.</p>
        </div>
