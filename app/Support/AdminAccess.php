...
final class AdminAccess
{
    ...
    private const LANDING_ROUTE_ORDER = [
        ...
        ['route' => 'admin.colleague.support.index', 'perm' => 'colleague.support.view'],
        ['route' => 'admin.colleague.sales.index', 'perm' => 'colleague.sales.view'],
        ['route' => 'admin.colleague.chat.index', 'perm' => 'colleague.chat.view'],
        ['route' => 'admin.colleagues.index', 'perm' => 'colleagues.view'],
        ['route' => 'admin.accounting.colleague-wholesale.index', 'perm' => 'colleague.wholesale.view_list'],
    ];
