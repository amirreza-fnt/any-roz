...
use App\Http\Controllers\Admin\Accounting\ColleagueWholesaleController;
...
use App\Http\Controllers\Admin\Colleagues\ColleagueController;
use App\Http\Controllers\Admin\Colleagues\ColleagueSaleController;
use App\Http\Controllers\Admin\Colleagues\ColleagueChatController;
use App\Http\Controllers\Admin\Colleagues\ColleagueSupportController;
    ...
    Route::middleware('auth:admin')->group(function () {
        ...
        Route::middleware('admin.permission')->group(function () {
            ...
            Route::prefix('accounting')->name('accounting.')->group(function () {
                ...
                Route::prefix('colleague-wholesale')->name('colleague-wholesale.')->group(function () {
                    Route::get('/', [ColleagueWholesaleController::class, 'index'])->name('index');
                    Route::get('{marketing_sale}', [ColleagueWholesaleController::class, 'show'])->name('show');
                    Route::post('{marketing_sale}/approve', [ColleagueWholesaleController::class, 'approve'])->name('approve');
                    Route::post('{marketing_sale}/reject', [ColleagueWholesaleController::class, 'reject'])->name('reject');
                });
            });
            ...
            Route::patch('products/{product}/toggle-suggested', [ProductController::class, 'toggleSuggested'])->name('products.toggle-suggested');
            ...
            Route::prefix('colleagues')->name('colleagues.')->group(function () {
                ...
                Route::post('/', [ColleagueController::class, 'store'])->name('store');
                Route::get('{colleague}', [ColleagueController::class, 'show'])->name('show');
                Route::get('{colleague}/edit', [ColleagueController::class, 'edit'])->name('edit');
                Route::put('{colleague}', [ColleagueController::class, 'update'])->name('update');
                Route::delete('{colleague}', [ColleagueController::class, 'destroy'])->name('destroy');
                Route::post('{colleague}/toggle-active', [ColleagueController::class, 'toggleActive'])->name('toggle-active');
            });

            Route::prefix('colleague-sales')->name('colleague.sales.')->group(function () {
                Route::prefix('api')->name('api.')->group(function () {
                    Route::get('products', [ColleagueSaleController::class, 'apiProducts'])->name('products');
                    Route::get('products/{product}', [ColleagueSaleController::class, 'apiProductJson'])->name('products.show');
                });

                Route::get('/', [ColleagueSaleController::class, 'index'])->name('index');
                Route::get('create', [ColleagueSaleController::class, 'create'])->name('create');
                Route::post('/', [ColleagueSaleController::class, 'store'])->name('store');
                Route::get('{marketing_sale}', [ColleagueSaleController::class, 'show'])->name('show');
                Route::delete('{marketing_sale}', [ColleagueSaleController::class, 'destroy'])->name('destroy');
            });

            Route::prefix('colleague-chat')->name('colleague.chat.')->group(function () {
                Route::get('/', [ColleagueChatController::class, 'index'])->name('index');
                Route::get('messages', [ColleagueChatController::class, 'messages'])->name('messages');
                Route::get('unread', [ColleagueChatController::class, 'unread'])->name('unread');
                Route::post('send', [ColleagueChatController::class, 'send'])->name('send');
            });

            Route::prefix('colleague-support')->name('colleague.support.')->group(function () {
                Route::get('/', [ColleagueSupportController::class, 'index'])->name('index');
                Route::get('conversations', [ColleagueSupportController::class, 'conversations'])->name('conversations');
                Route::get('messages', [ColleagueSupportController::class, 'messages'])->name('messages');
                Route::get('unread', [ColleagueSupportController::class, 'unread'])->name('unread');
                Route::post('send', [ColleagueSupportController::class, 'send'])->name('send');
            });
        });
    });
});
