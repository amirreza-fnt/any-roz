...
return [
    'route_permissions' => [
        ...
        'admin.colleagues.index' => 'colleagues.view',
        'admin.colleagues.create' => 'colleagues.create',
        'admin.colleagues.store' => 'colleagues.create',
        'admin.colleagues.show' => 'colleagues.view',
        'admin.colleagues.edit' => 'colleagues.edit',
        'admin.colleagues.update' => 'colleagues.edit',
        'admin.colleagues.destroy' => 'colleagues.delete',
        'admin.colleagues.toggle-active' => 'colleagues.toggle_status',

        'admin.colleague.sales.index' => 'colleague.sales.view',
        'admin.colleague.sales.create' => 'colleague.sales.create',
        'admin.colleague.sales.store' => 'colleague.sales.create',
        'admin.colleague.sales.show' => 'colleague.sales.view',
        'admin.colleague.sales.destroy' => 'colleague.sales.delete',
        'admin.colleague.sales.api.products' => 'colleague.sales.view',
        'admin.colleague.sales.api.products.show' => 'colleague.sales.view',

        'admin.colleague.chat.index' => 'colleague.chat.view',
        'admin.colleague.chat.messages' => 'colleague.chat.view',
        'admin.colleague.chat.unread' => 'colleague.chat.view',
        'admin.colleague.chat.send' => 'colleague.chat.send',

        'admin.colleague.support.index' => 'colleague.support.view',
        'admin.colleague.support.conversations' => 'colleague.support.view',
        'admin.colleague.support.messages' => 'colleague.support.view',
        'admin.colleague.support.unread' => 'colleague.support.view',
        'admin.colleague.support.send' => 'colleague.support.send',

        'admin.accounting.colleague-wholesale.index' => 'colleague.wholesale.view_list',
        'admin.accounting.colleague-wholesale.show' => 'colleague.wholesale.view_detail',
        'admin.accounting.colleague-wholesale.approve' => 'colleague.wholesale.approve',
        'admin.accounting.colleague-wholesale.reject' => 'colleague.wholesale.reject',
    ],
    ...
    'permission_ui' => [
        ...
        [
            'id' => 'colleagues',
            'label' => 'همکاران (خرید کلی)',
            'items' => [
                ['key' => 'colleagues.view', 'label' => 'همکاران — مشاهدهٔ لیست و جزئیات'],
                ['key' => 'colleagues.create', 'label' => 'همکاران — افزودن'],
                ['key' => 'colleagues.edit', 'label' => 'همکاران — ویرایش'],
                ['key' => 'colleagues.delete', 'label' => 'همکاران — حذف'],
                ['key' => 'colleagues.toggle_status', 'label' => 'همکاران — فعال / غیرفعال'],
                ['key' => 'colleague.sales.view', 'label' => 'پنل همکار — مشاهدهٔ پیش‌فاکتورهای خرید کلی'],
                ['key' => 'colleague.sales.create', 'label' => 'پنل همکار — ثبت پیش‌فاکتور خرید کلی'],
                ['key' => 'colleague.sales.delete', 'label' => 'پنل همکار — حذف پیش‌فاکتور در انتظار'],
                ['key' => 'colleague.chat.view', 'label' => 'پنل همکار — چت با پشتیبانی (مشاهده)'],
                ['key' => 'colleague.chat.send', 'label' => 'پنل همکار — چت با پشتیبانی (ارسال پیام)'],
                ['key' => 'colleague.support.view', 'label' => 'پشتیبانی — چت با همکاران (لیست و مشاهده)'],
                ['key' => 'colleague.support.send', 'label' => 'پشتیبانی — چت با همکاران (ارسال پیام)'],
                ['key' => 'colleague.wholesale.view_list', 'label' => 'حسابداری — مشاهدهٔ لیست خرید کلی همکاران'],
                ['key' => 'colleague.wholesale.view_detail', 'label' => 'حسابداری — مشاهدهٔ جزئیات خرید کلی'],
                ['key' => 'colleague.wholesale.approve', 'label' => 'حسابداری — تأیید و صدور فاکتور خرید کلی'],
                ['key' => 'colleague.wholesale.reject', 'label' => 'حسابداری — رد خرید کلی'],
            ],
        ],
    ],
];
